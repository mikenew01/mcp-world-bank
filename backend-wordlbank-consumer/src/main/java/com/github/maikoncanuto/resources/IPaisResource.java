...
public interface IPaisResource {
    ...
    @Retry
    @Operation(
            description = "Buscar informações de paises na base de dados do World Bank atravez do produtor",
            operationId = "paises#findAll",
    ...
    Response findAll(@QueryParam("paginaAtual") final Integer paginaAtual,
