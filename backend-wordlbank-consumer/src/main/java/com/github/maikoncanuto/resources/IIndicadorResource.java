...
@Tag(name = "Indicadores", description = "Endpoints para acessar informações de indicadores na base dados do World Bank pelo Producer")
public interface IIndicadorResource {
    ...
    @Retry
    @Operation(
            description = "Buscar informações de indicadores de paises na base de dados do World Bank atraves do Producer",
            operationId = "countries#findIndicadorByCodigoPais",
    ...
    Response findIndicadorByCodigoPais(@PathParam("codigoPais") @NotNull final String codigoPais,
